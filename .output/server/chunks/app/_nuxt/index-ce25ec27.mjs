...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` ${ssrInterpolate(__props.item.name)}</div><div class="w-4/12">${ssrInterpolate(__props.item.slug)}</div><div class="w-2/12 flex items-center justify-end"><a href="" class="block w-5 h-5 mx-1 text-dark-main hover:text-main">`);
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layout/admin/regions/RegionsListItem.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      ssrRenderList(unref(regionsList), (item) => {
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layout/admin/regions/RegionsList.vue");
  ...
  setup(__props) {
    ...
    const popupOpen = (item) => {
      ...
      if (item == null ? void 0 : item.id) {
        ...
        inputIsActive.value = (item == null ? void 0 : item.isActive) || false;
      ...
      userData.updateRegion({
        ...
        if (result) {
          if (result == null ? void 0 : result.errors)
            return setErrors("regions_form", [], result.errors);
            ...
            _push2(ssrRenderComponent(_sfc_main$1$1, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="hidden md:inline"${_scopeId2}>\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0440\u0435\u0433\u0438\u043E\u043D\u0430</span>`);
                } else {
                  return [
                    ...
                    createVNode("span", { class: "hidden md:inline" }, "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0440\u0435\u0433\u0438\u043E\u043D\u0430")
                  ];
                }
              }),
              _: 1
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(_component_FormKit, {
                                ...
                                name: "isActive",
                                id: "isActive",
                                label: "\u041E\u0442\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435 \u0440\u0435\u0433\u0438\u043E\u043D\u0430 \u043D\u0430 \u0441\u0430\u0439\u0442\u0435",
                                modelValue: unref(inputIsActive),
                                "onUpdate:modelValue": ($event) => isRef(inputIsActive) ? inputIsActive.value = $event : null
                              }, null, _parent5, _scopeId4));
                            } else {
                              return [
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layout/admin/Regions.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/client/regions/index.vue");
