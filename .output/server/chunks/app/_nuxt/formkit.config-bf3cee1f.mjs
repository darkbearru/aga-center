...
import { k as defineFormKitConfig } from '../server.mjs';
...
const formkitTailwindTheme = {
  ...
  "family:box": {
    decorator: "block relative h-5 w-5 mr-2 rounded bg-white from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-main peer-checked:bg-main text-transparent peer-checked:text-white",
  ...
  "family:dropdown": {
    ...
    inner: "max-w-md relative flex ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 rounded mb-0 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-blue-500",
  ...
  "family:text": {
    inner: "flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-main focus-within:ring-2 [&>label:first-child]:focus-within:text-main rounded mb-0 bg-white",
    input: "w-full px-3 py-2 border-none text-base text-gray-700 placeholder-gray-400"
  },
  "family:date": {
    inner: "flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-0",
  ...
  select: {
    inner: "flex relative max-w-md items-center rounded mb-0 ring-1 ring-gray-400 focus-within:ring-main focus-within:ring-2 focus-within:ring-2 [&>span:first-child]:focus-within:text-blue-500 bg-white",
  ...
  textarea: {
    inner: "flex max-w-md rounded mb-0 ring-1 ring-gray-400 focus-within:ring-main focus-within:ring-2 [&>label:first-child]:focus-within:text-main bg-white",
...
const formkit_config = defineFormKitConfig({
  locales: { ru },
  locale: "ru",
  icons: {
    ...genesisIcons
...
export { formkit_config as default };
