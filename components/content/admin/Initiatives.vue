...
import InitiativeList from '~/components/content/admin/initiatives/InitiativeList.vue';
import InitiativeForm from '~/components/content/admin/initiatives/InitiativeForm.vue';
